...
const Home = () => {
  ...
  const homePageSchema = {
    ...
    description:
      "Welcome to Essence Treks, your premier trekking and adventure partner in Nepal. Discover the majestic Himalayas with our expert guides.",
    mainEntity: {
      "@type": "TravelAgency",
      name: "Essence Treks",
      description:
        "Nepal's leading trekking and adventure company offering professional guided tours in the Himalayas.",
      address: {
        "@type": "PostalAddress",
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover the best trekking and adventure tours in Nepal with Essence Treks. Professional guides, eco-friendly tours, and unforgettable Himalayan experiences. Book your adventure today!"
        />
        <meta
          name="keywords"
          content="Nepal trekking, Himalayan adventures, eco-tourism, trekking tours, Nepal travel, adventure tourism, mountain trekking, cultural tours, Pokhara trekking, Annapurna trek, Everest base camp"
        />
        ...
        <meta
          property="og:title"
          content="Essence Treks - Your Adventure Partner in Nepal"
        />
        <meta
          property="og:description"
          content="Discover the best trekking and adventure tours in Nepal with Essence Treks. Professional guides, eco-friendly tours, and unforgettable Himalayan experiences."
        />
        <meta
          property="og:image"
          content="https://essencetreks.com/hero-bg.jpg"
        />
        ...
        <meta
          name="geo.position"
          content="28.217773996433355;83.95865098651072"
        />
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-300 text-base md:text-lg max-w-2xl mx-auto px-4">
              A journey through the breathtaking landscapes and unforgettable
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            >
              ...
              <p className="text-gray-300">
                Experience the majestic Annapurna Base Camp trek with
                professional guides and comfortable accommodations.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <p className="text-gray-300">
                Trek to the base of the world's highest mountain with
                experienced guides and proper acclimatization.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <p className="text-gray-300">
                Tailored trekking experiences to suit your preferences and
                fitness level.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-gray-300">
                Professional guided tours with knowledgeable and experienced
                guides.
              </p>
            </motion.div>
          </div>
      ...
      <section className="py-20 relative">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-gray-200 mb-8 max-w-2xl mx-auto">
            ...
            Our expert guides are ready to make your dream adventure a reality.
          </p>
          <Link
            to="/contact"
