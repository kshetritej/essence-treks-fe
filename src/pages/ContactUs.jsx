import { FaMapMarkerAlt, FaPhoneAlt, FaEnvelope, FaWhatsapp, FaFacebook } from "react-icons/fa";
            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-gray-200 mt-4 max-w-2xl mx-auto">
                        Fill out the form below and we'll receive your message directly on WhatsApp!
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    {/* Contact Information */}
                    <div className="bg-[#23272f] bg-opacity-95 rounded-xl shadow-2xl p-8">
                        <h3 className="text-2xl font-bold text-white mb-8 border-b border-gray-700 pb-4">Contact Information</h3>
                        ...
                        <div className="space-y-6 mb-8">
                            <div className="flex items-start gap-4 p-3 rounded-lg hover:bg-gray-800 transition-colors">
                                ...
                                <div>
                                    <h4 className="text-gray-300 font-semibold mb-1">Our Location</h4>
                                    <p className="text-gray-400">Essence Tours and Travels & Treks and Expedition Pvt. LTD.</p>
                            ...
                            <div className="flex items-start gap-4 p-3 rounded-lg hover:bg-gray-800 transition-colors">
                                ...
                                <div>
                                    <h4 className="text-gray-300 font-semibold mb-1">Phone Numbers</h4>
                            ...
                            <div className="flex items-start gap-4 p-3 rounded-lg hover:bg-gray-800 transition-colors">
                                ...
                                <div>
                                    <h4 className="text-gray-300 font-semibold mb-1">Email Address</h4>
